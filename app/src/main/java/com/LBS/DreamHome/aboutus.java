                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (menuItem.getTitle().equals("Dashboard")) {
                            ...
                            Intent i = new Intent(aboutus.this, HaveHome.class);
                            startActivity(i);
                        } else if (menuItem.getTitle().equals("Need Home")) {
                            Intent i = new Intent(aboutus.this, Filter.class);
                            startActivity(i);
                            ...
                            Intent i = new Intent(aboutus.this, preferences.class);
                            startActivity(i);
                        } else if (menuItem.getTitle().equals("My shortlists")) {
                            Intent i = new Intent(aboutus.this, Shortlist.class);
                            startActivity(i);
                        } else if (menuItem.getTitle().equals("My Houses")) {
                            Intent i = new Intent(aboutus.this, Uploads.class);
                            startActivity(i);
                        }
                        return true;
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_item_two:
                Intent i = new Intent(aboutus.this, ChatList.class);
                startActivity(i);
                return true;
        }
